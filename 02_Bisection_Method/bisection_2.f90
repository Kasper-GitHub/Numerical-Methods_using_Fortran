! Name : Ankush Bhowmik
! Date : 08-10-2024
! Program Name : Root Finding for f(x) = x*e^(x) - 1 using Bisection Method

PROGRAM root_finding_bisection_2
	...
	x_a = 0.0	!! Lower Bound of Interval
	x_b = 1.0	!! Upper Bound of Interval
	y_a = f(x_a)
	y_b = f(x_b)
	
	PRINT*,"Problem Statement : f(x) = x*e^(x) - 1"
